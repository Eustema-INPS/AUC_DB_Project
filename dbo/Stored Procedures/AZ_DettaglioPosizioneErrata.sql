...
-- ===============================================================================================
-- Modificata da: palmieri
-- Data modifica:  2018.10.22
-- Description:	AI 3115 Aggiunta posizione in output
-- ===============================================================================================
CREATE PROCEDURE [dbo].[AZ_DettaglioPosizioneErrata]
	@codice_pk int
AS
BEGIN
	...
	SELECT 
		...
		(SELECT COUNT(tb_aupoe_PosizioniErrate_Aurpp.aurpp_codice_pk)
		 ...
		 WHERE tb_aupoe_PosizioniErrate_Aurpp.aurpp_aupoc_cod_pk_figlia=@codice_pk) 
		 AS DB_NumPosizioniSecondarie,
		 
		(SELECT COUNT(tb_aupoe_PosizioniErrate_Aurpp.aurpp_codice_pk) 
		 FROM tb_aupoe_PosizioniErrate_Aurpp
		 WHERE tb_aupoe_PosizioniErrate_Aurpp.aurpp_aupoc_cod_pk_madre=@codice_pk)   
	...
	on [dbo].tb_aupoe_PosizioniErrate_Aurpp.aurpp_codice_pk = @codice_pk
