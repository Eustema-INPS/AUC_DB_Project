...
-- Create date: 25/5/2012
-- Description:	Stored Procedure per caricare TUTTI i soggetti collegati all'azienda
...
-- Modificata da: Raffaele
-- Data:		01.02.2013
-- Descrizione:	Modificato il criterio di estrazione dei soggetti: non considera i rappresentanti legali
...
-- =============================================
CREATE PROCEDURE [dbo].[AZ_ElencoSoggettiCollegatiFiltro]
	@codiceAzienda int
AS
BEGIN
	...
	WHERE ausca_codice_pk = @codiceAzienda 	AND (aurss_rappresentante_legale = 'N' or aurss_rappresentante_legale is null or aurss_rappresentante_legale = '')
