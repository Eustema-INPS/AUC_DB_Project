...
-- Descrizione: 
-- Modificata da Raffaele il 2018.05.23
-- Eliminato il vincolo sullo stato della posizione
-- =============================================
CREATE PROCEDURE  [dbo].[AZ_StoricoComunicazioni] 
...
WHERE    (tb_aupoc_pos_contr.aupoc_codice_pk = @codiceAupocPK) --AND (tb_aupoc_pos_contr.aupoc_auspc_codice_pk <> 1)
