...
CREATE PROCEDURE [dbo].[AZ_ElencoAltroResponsabile]
	@codiceAzienda int
AS
BEGIN
...
SELECT
	...
	AND ( convert(date,GETDATE(),103) BETWEEN tb_aursp_rel_sog_pos.aursp_data_inizio_validita AND tb_aursp_rel_sog_pos.aursp_data_di_fine_validita
