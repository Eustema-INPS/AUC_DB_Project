...
-- Description:	Stored Procedure per caricare i soggetti collegati all'azienda
...
-- =============================================
-- =============================================
CREATE PROCEDURE [dbo].[AZ_ElencoSoggettiCollegati]
	@codiceAzienda int
AS
BEGIN
	...
	(aurss_rappresentante_legale = 'N' or aurss_rappresentante_legale is null or aurss_rappresentante_legale = '')
