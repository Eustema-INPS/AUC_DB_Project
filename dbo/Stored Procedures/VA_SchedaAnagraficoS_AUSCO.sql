...
-- Description:	Stored per dettagli scheda anagrafica del soggetto
-- =============================================
CREATE PROCEDURE [dbo].[VA_SchedaAnagraficoS_AUSCO]
	@codfisca varchar(16)
AS
BEGIN
	...
	SET NOCOUNT ON;
		...
		ausco_denominazione		AS DB_Denominazione, 
	...
	WHERE ausco_codice_fiscale =  @codfisca
END
