CREATE TABLE [dbo].[Sync_DM_auuop] (
    [St_auuop_aupoc_accentrante]        VARCHAR (MAX) NULL,
    ...
    [St_auuop_unita_operativa]          CHAR (1)      CONSTRAINT [DF_Sync_DM_auuop_St_auuop_unita_operativa] DEFAULT ('N') NULL,
    [St_auuop_unita_produttiva]         CHAR (1)      CONSTRAINT [DF_Sync_DM_auuop_St_auuop_unita_produttiva] DEFAULT ('N') NULL
);
