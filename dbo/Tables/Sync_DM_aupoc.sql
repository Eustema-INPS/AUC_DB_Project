CREATE TABLE [dbo].[Sync_DM_aupoc] (
    ...
    [St_aupoc_Presente]                     INT           NULL,
    [St_aupoc_InquadrAuto_acquisizione]     VARCHAR (20)  NULL,
    [St_aupoc_InquadrAuto_validazione]      VARCHAR (20)  NULL,
    [St_aupoc_Data_Validazione]             VARCHAR (10)  NULL,
    [St_aupoc_Data_Iscrizione_Provvisioria] VARCHAR (10)  NULL
);
