CREATE TABLE [dbo].[tb_ausco_sog_contr_col] (
    [ausco_codice_pk]                INT           IDENTITY (1, 1) NOT NULL,
    ...
    [ausco_certificato_arca]         CHAR (1)      CONSTRAINT [DF_tb_ausco_sog_contr_col_ausco_certificato_arca] DEFAULT ('N') NULL,
    [ausco_data_agg_arca]            DATETIME      NULL,
    [ausco_data_morte]               DATETIME      NULL,
    [ausco_ind_qualita_indir]        INT           CONSTRAINT [DF_tb_ausco_sog_contr_col_ausco_ind_qualita_indir] DEFAULT ((0)) NULL,
    [ausco_aurea_codice_pk]          INT           CONSTRAINT [DF_tb_ausco_sog_contr_col_ausco_aurea_codice_pk] DEFAULT ((0)) NULL,
    ...
    CONSTRAINT [PK_tb_ausco] PRIMARY KEY CLUSTERED ([ausco_codice_pk] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [UQ_ausco_ausco] UNIQUE NONCLUSTERED ([ausco_codice_pk] ASC) WITH (FILLFACTOR = 90),
    CONSTRAINT [UQ_ausco_CF] UNIQUE NONCLUSTERED ([ausco_codice_fiscale] ASC) WITH (FILLFACTOR = 90)
);
