CREATE TABLE [dbo].[tb_auraz_report_azst_old] (
    ...
    [auraz_data_modifica]          DATETIME      CONSTRAINT [DF_tb_auraz_report_azst_auraz_data_modifica] DEFAULT (getdate()) NULL,
    [auraz_descr_utente]           VARCHAR (50)  NULL,
    [Auraz_stato]                  INT           CONSTRAINT [DF_tb_auraz_report_azst_Auraz_stato] DEFAULT ((0)) NULL,
    ...
    CONSTRAINT [PK_tb_auraz] PRIMARY KEY CLUSTERED ([auraz_codice_pk] ASC),
    CONSTRAINT [UQ_auraz_auraz] UNIQUE NONCLUSTERED ([auraz_codice_pk] ASC)
);
